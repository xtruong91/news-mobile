...
import com.xtruong.petapp.databinding.ActivityRecyclerProfileBinding;
import com.xtruong.petapp.data.db.model.recyclerview.Post;
import com.xtruong.petapp.data.db.model.recyclerview.User;
import com.xtruong.petapp.utils.GridSpacingItemDecoration;
...
public class ProfileActivity extends AppCompatActivity  implements PostsAdapter.PostsAdapterListener{
    ...
    private ActivityRecyclerProfileBinding binding;
    private User user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_recycler_profile);
    ...
    private void renderProfile() {
        user = new User();
        user.setName("Xuan Truong");
        user.setEmail("truongtx91@gmail.com");
