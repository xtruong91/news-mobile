package com.xtruong.petapp.ui.flightticket;
...
import com.xtruong.petapp.data.network.ApiFlightService;
 ...
 */
public class FlightTicketActivity extends AppCompatActivity implements TicketsAdapter.TicketsAdapterListener {

    private static final String TAG = FlightTicketActivity.class.getSimpleName();
    ...
    private ApiFlightService apiService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recycler_flightticket);
        ...
        apiService = ApiClient.getClient().create(ApiFlightService.class);

        mAdapter = new TicketsAdapter(this, ticketsList, this);

        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(this, 1);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.addItemDecoration(new FlightTicketActivity.GridSpacingItemDecoration(1, dpToPx(5), true));
